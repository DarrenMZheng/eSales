...
const userNav = options => {
  const nav = [
    ...
    },
    {
      ...
      parentId: 10010,
      id: 10011,
      path: '/list/table-list/product',
      meta: {
        title: '产品',
        show: true
      },
      redirect: '/list/table-list/product/:pageNo([1-9]\\d*)?',
      component: 'RouteView'
    },
    {
      name: 'product',
      parentId: 10011,
      id: 10998,
      path: '/list/table-list/product/:pageNo([1-9]\\d*)?',
      meta: {
        title: '险种',
        show: true
      },
    ...
    },
    {
      ...
      parentId: 10011,
      id: 10999,
      path: '/list/table-list/product-plan/:pageNo([1-9]\\d*)?',
      meta: {
        title: '产品计划',
        show: true
      },
